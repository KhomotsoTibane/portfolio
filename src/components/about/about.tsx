    ...
    <section id="about">
      ...
      <div className="app__container app__about-container">
        ...
        <div className="app__about-content">
          ...
          <p>
            I am a Frontend Developer currently working and studying Computer Science part-time. I
            enjoy learning new programming technologies and I have a superior capacity for
            understanding concepts. I always aim to deliver quality solutions to problems that I am
            required to solve with the highest standard.
          </p>
        </div>
      </div>
    </section>
